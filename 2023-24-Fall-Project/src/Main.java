...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<City> cities = CSVParser.parseCities("ceren_beyda_cities.csv"); // Replace with your cities CSV file

        // Parse songs from CSV
        List<Song> songs = Knapsack.parseSongs("songs_data.csv"); // Replace with your songs CSV file
